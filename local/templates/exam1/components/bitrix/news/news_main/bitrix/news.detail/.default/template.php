...
<div class="review-block">
	...
	<?if(!empty($arResult['DISPLAY_PROPERTIES']['FILES'])):?>
		<div class="exam-review-doc">
			<p><?=$arResult['DISPLAY_PROPERTIES']['FILES']['NAME']?>:</p>
			
			<?foreach($arResult['DISPLAY_PROPERTIES']['FILES']['FILE_VALUE'] as $key => $value):?>
				<div class="exam-review-item-doc">
					<img class="rew-doc-ico" src="<?=SITE_TEMPLATE_PATH?>/img/icons/pdf_ico_40.png">
					<a href="<?=$arResult['DISPLAY_PROPERTIES']['FILES']['FILE_VALUE'][$key]['SRC']?>">
						<?=$arResult['DISPLAY_PROPERTIES']['FILES']['FILE_VALUE'][$key]['ORIGINAL_NAME']?>
					</a>
				</div>
			<?endforeach?>
